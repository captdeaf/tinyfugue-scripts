...
die "What, you want me to pick a random character?  I don't think so." unless defined($character);

$remote = "eaccess.play.net"; # don't see any way to avoid hard coding this
$port = 7900;			# nor this
